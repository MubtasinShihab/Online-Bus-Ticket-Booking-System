    ...
    <div id="link-to-click" class="bg-white w-[54%] border border-green-300 mx-auto rounded-3xl p-6 flex">
        ...
        <div class="">
            ...
            <div class="flex justify-between">
                ...
                <div>
                    <button class="btn bg-[#1DD1001A] text-[#1DD100] text-xl font-bold rounded-xl w-48 h-14 mx-auto flex-col">
            ...
            <!-- Route details -->
            <div
                class="bg-[#F7F8F8] w-[808px] mt-6 rounded-3xl p-8 font-raleway font-semibold text-lg">
                ...
                <div class="mt-6">
                    <button class="btn w-52 h-14 bg-[#0307120D] rounded-xl ml-6 font-semibold">Boarding Point - Dhaka</button>
                    <button class="btn w-52 h-14 bg-[#0307120D] rounded-xl ml-6 font-semibold">Departure Point - Sylhet</button>
                    <button class="btn w-52 h-14 bg-[#0307120D] rounded-xl ml-6 font-semibold">Est. Time - 11 Hour</button>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col justify-center font-raleway">
            ...
            <p class="leading-10 mt-6">
                <span class="font-bold text-3xl">550 Taka</span> <br>
                <span class="font-semibold text-2xl">Per Seat</span>
            </p>
        </div>
