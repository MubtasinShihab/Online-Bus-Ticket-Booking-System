    ...
    <div class="bg-slate-200/50 w-3/4 mx-auto rounded-xl">
        ...
        <div class="flex gap-4 mb-5 ml-20">
            ...
            <div class="relative max-w-lg">
                ...
                <input type="text" class="w-80 h-14 rounded-[4px] bg-gray-50 border border-gray-300 placeholder-gray-400 shadow-md shadow-gray-500 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block ps-10 p-2.5" placeholder="From">
            </div>
            ...
            <div class="relative max-w-lg">
                ...
                <input type="text" class="w-80 h-14 bg-gray-50 border border-gray-300 placeholder-gray-400 shadow-md shadow-gray-500 text-gray-900 text-sm rounded-[4px] focus:ring-blue-500 focus:border-blue-500 block ps-10 p-2.5" placeholder="To">
            </div>
